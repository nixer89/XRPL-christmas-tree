...
export const XRP_PER_MINUTE:number = new Number(process.env.XRP_PER_MINUTE).valueOf() || 0.05;
export const USE_PROXY:boolean = new Boolean(process.env.USE_PROXY).valueOf() || false;
...
//REMOTECONTROL
export const ENABLE_REMOTE_CONTROL:boolean = new Boolean(process.env.ENABLE_REMOTE_CONTROL).valueOf() || false;
